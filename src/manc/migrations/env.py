"""Alembic environment: targets manc.store.schema.metadata, URL from MANC_DB_URL."""
...
from manc.store.schema import metadata
...
config.set_main_option("sqlalchemy.url", config.attributes.get("url") or db.database_url())
